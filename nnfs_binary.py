...
# y = y.reshape(-1, 1)
# np.savetxt("X_train_bin.csv", X, delimiter=",")
# np.savetxt("y_train_bin.csv", y, delimiter=",")

X = np.loadtxt("X_train_bin.csv", delimiter=",")
...
dense1.weights = np.loadtxt("weights1_bin.csv", delimiter=",")
dense2.weights = np.loadtxt("weights2_bin.csv", delimiter=",").reshape(-1, 1)

# np.savetxt("weights1_bin.csv", dense1.weights, delimiter=",")
# np.savetxt("weights2_bin.csv", dense2.weights, delimiter=",")

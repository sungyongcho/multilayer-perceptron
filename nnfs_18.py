...
# np.savetxt("X_train_18.csv", X, delimiter=",")
# y = y.astype(int)
# np.savetxt("y_train_18.csv", y, delimiter=",")
X = np.loadtxt("X_train_18.csv", delimiter=",")
y = np.loadtxt("y_train_18.csv", delimiter=",").astype(int)
# X_test, y_test = spiral_data(samples=100, classes=3)
X_test = np.loadtxt("X_test_18.csv", delimiter=",")
y_test = np.loadtxt("y_test_18.csv", delimiter=",").astype(int)
# np.savetxt("X_test_18.csv", X, delimiter=",")
# np.savetxt("y_test_18.csv", y, delimiter=",").astype(int)
...
for layer in model.layers:
    if hasattr(layer, "weights"):
        # lnp.savetxt(f"weights{i}_18.csv", layer.weights, delimiter=",")
        layer.weights = np.loadtxt(f"weights{i}_18.csv", delimiter=",")
        # print(i)
        i += 1
# # Train the model

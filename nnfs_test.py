...
dense1.weights = np.loadtxt("weights1.csv", delimiter=",", dtype=np.float64)
...
dense2.weights = np.loadtxt("weights2.csv", delimiter=",", dtype=np.float64)
# np.savetxt("weights2.csv", dense2.weights, delimiter=",")
